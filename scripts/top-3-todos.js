...
function updateDropDownText() {
  ...
  window.addEventListener("change", function () {
    dropDownText =
      dropDownSelection.options[dropDownSelection.selectedIndex].text;
  });
}
...
function saveTaskOne() {
  localStorage.setItem("todoOne", todoOne.innerHTML);
...
if (
  todoOne.innerHTML === "" ||
  todoOne.innerHTML.includes("1. ...") ||
  todoOne.innerHTML === undefined
) {
} else {
...
if (
  todoTwo.innerHTML === "" ||
  todoTwo.innerHTML.includes("2. ...") ||
  todoTwo.innerHTML === undefined
) {
} else {
...
if (
  todoThree.innerHTML === "" ||
  todoThree.innerHTML.includes("3. ...") ||
  todoThree.innerHTML === undefined
) {
} else {
